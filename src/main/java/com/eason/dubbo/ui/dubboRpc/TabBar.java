...
import com.eason.dubbo.action.CloseTabAction;
...
public class TabBar extends JBEditorTabs implements TabsListener {
    ...
    public void addTab() {
        ...
        TabWindow tab = new TabWindow(this.project, tabId, this.leftTree);
    ...
    public void selectionChanged(TabInfo oldSelection, TabInfo newSelection) {
        TabWindow tab = (TabWindow) newSelection.getComponent();
